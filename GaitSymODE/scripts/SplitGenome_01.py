...
def main():
    ...
    for i in range(0, populationLength):
        ...
        c = c + 1
        if genomeLength % 7 != 0:
            PrintExit("Genome length multiple of 7 required")
        ...
        outpop.append(-1)
        outpop.append(genomeLength * 2) # genome length
        
        blocks = genomeLength / 7
        for b in range(0, blocks):
            o = b * 7
            outpop.append(genome[o] / 2) # time
            outpop.append(genomeLow[o] / 2)
            outpop.append(genomeHigh[o] / 2)
            outpop.append(0) # set SD to zero
            for j in range(0, 6):
                outpop.append(genome[o + j + 1])
                outpop.append(genomeLow[o + j + 1])
                outpop.append(genomeHigh[o + j + 1])
                outpop.append(genomeSD[o + j + 1])
