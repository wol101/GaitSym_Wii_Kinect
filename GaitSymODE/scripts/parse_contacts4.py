...
def main():
    ...
    print "Time LeftFootX LeftFootY LeftFootZ RightFootX RightFootY RightFootZ LeftHandX LeftHandY LeftHandZ RightHandX RightHandY RightHandZ"
    lastTime = -1
    LeftFootX = LeftFootY = LeftFootZ = 0
    RightFootX = RightFootY = RightFootZ = 0
    LeftHandX = LeftHandY = LeftHandZ = 0
    RightHandX = RightHandY = RightHandZ = 0
    for line in theLines:
        ...
        if (time != lastTime):
            if (lastTime != -1):
                print "%f %f %f %f %f %f %f %f %f %f %f %f %f" % (lastTime, LeftFootX, LeftFootY, LeftFootZ, RightFootX, RightFootY, RightFootZ, LeftHandX, LeftHandY, LeftHandZ, RightHandX, RightHandY, RightHandZ)
            lastTime = time
            LeftFootX = LeftFootY = LeftFootZ = 0
            RightFootX = RightFootY = RightFootZ = 0
            LeftHandX = LeftHandY = LeftHandZ = 0
        ...
        if (tokens[2] == "LeftHand"):
            LeftHandX += float(tokens[11])
            LeftHandY += float(tokens[12])
            LeftHandZ += float(tokens[13])
        if (tokens[2] == "RightHand"):
            RightHandX += float(tokens[11])
            RightHandY += float(tokens[12])
            RightHandZ += float(tokens[13])
