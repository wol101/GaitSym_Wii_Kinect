...
void GLUtils::SetColourFromMap(GLfloat index, ColourMap m, Colour *mappedColour, bool invert)
{

    static GLfloat grey[256][4] =
    {
        {0,0,0,1},
