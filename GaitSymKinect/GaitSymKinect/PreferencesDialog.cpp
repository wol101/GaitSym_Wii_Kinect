...
void PreferencesDialog::setValues(const Preferences &prefs)
{
    ...
    ui->lineEditSensorInterval->setText(QString("%1").arg(prefs.SensorInterval));
    ...
    ui->checkBoxAutoTrack->setChecked(prefs.TrackingFlag);
    ui->checkBoxRestoreWindows->setChecked(prefs.RestoreWindowsFlag);
    ui->checkBoxFactoryDefaults->setChecked(prefs.FactorDefaultsFlag);
...
void PreferencesDialog::getValues(Preferences *prefs)
{
    ...
    prefs->SensorInterval = ui->lineEditSensorInterval->text().toInt();
    ...
    prefs->TrackingFlag = ui->checkBoxAutoTrack->isChecked();
    prefs->RestoreWindowsFlag = ui->checkBoxRestoreWindows->isChecked();
    prefs->FactorDefaultsFlag = ui->checkBoxFactoryDefaults->isChecked();
